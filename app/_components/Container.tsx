...
export default function Container({ children }: ContainerProps) {
  ...
  return (
    <main
      className={clsx(`w-full h-full min-h-screen transition duration-500 py-4`, {
    ...
    >
      <section
        className={clsx(
          "flex flex-col p-4 mx-auto rounded transition duration-500 ease  w-full sm:w-[100%] md:w-[80%] lg:w-[60%] xl:w-[40%] 2xl:w-[40%]",
          {
